  ...
  constructor(element: HTMLElement, options?: Options) {
    ...
    this.options = {
      ...
      prevArrow:
        ...
        createElement(
          '<button type="button" class="a11y-slider-prev"><span class="material-symbols-outlined">arrow_back_ios</span></button>'
        ),
      nextArrow:
        (options && options.nextArrow) ||
        createElement(
            '<button type="button" class="a11y-slider-prev"><span class="material-symbols-outlined">arrow_forward_ios</span></button>'
        ),
      dots: true,
